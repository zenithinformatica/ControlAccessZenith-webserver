    ...
    return (
        <footer className="card col-sm-11 mx-auto mt-5 text-center text-light text-decoration-none header-background border-0">
            <div className="row mx-auto">
                <p className="h5 mt-1"><RiCopyrightLine size={20} /> Zenith Informática LTDA.</p>
                <a className="h5 mt-1 ml-3 text-light" href="https://github.com/gabrielrbernardi/controlAccessZenith" target="_blank" rel="noopener noreferrer"><IoLogoGithub size={25} /></a>
